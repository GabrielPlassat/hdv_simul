...
with tab_physique:
    ...
    # Reconstruit cum_km si absent (mode démo sans itinéraire OSM)
    if "cum_km" not in segs_df.columns:
        segs_df["cum_km"] = (segs_df["distance_m"].cumsum() - segs_df["distance_m"]) / 1000.0
